...
export interface FunfactProps extends HTMLAttributes<HTMLElement>, VariantProps<typeof FunfactVariants> {
    fact : string 
}
const FunfactItem = ({
    fact, 
...
{
    return (
        <div className={cn(FunfactVariants({ typoColor }) , className)} {...props}>
            {fact}
        </div>
    )
}
