...
{
    return (
        <div className="w-[330px] flex flex-col text-text items-center border border-white h-fit">
            <div 
                style={{
            ...
            <div className="grow-0 w-full">
                ...
                <div className="p-3">
                    <h1 className="font-semibold text-[24px] line-clamp-2">{name}</h1>
                    ...
                    <div className="mt-4 flex items-center justify-start gap-3">
                        <a href={visit} target="_blank">
                            <Button fill icon={<Zap />}>Visit</Button>
                        </a>
                    </div>
                </div>
            </div>
